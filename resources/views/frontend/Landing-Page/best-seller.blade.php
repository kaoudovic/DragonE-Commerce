<div class="divider-new version-2 mt-5 mb-0">
    <h4 class="text-uppercase font-weight-bold deep-grey-text mr-3">Best Selling</h4>
</div>
...
<section class="text-center mb-5">
    ...
    <!-- Carousel Wrapper -->
    <div id="multi-item-example-bestSeller" class="carousel slide carousel-multi-item" data-ride="carousel">
        <!-- Indicators -->
        <ol class="carousel-indicators">
            @for($i = 0;$i < count($best_selling);$i++)
                <li class="{{$i == 0 ? 'active' : ''}}" data-target="#multi-item-example-bestSeller" data-slide-to="{{$i}}"></li>
            @endfor
        </ol>
        ...
        <!-- Slides -->
        <a class="carousel-control-prev left carousel-control" data-slide="prev" href="#multi-item-example-bestSeller" role="button"
           data-slide="prev">
            <span class="icon-prev" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>

        <a class="carousel-control-next right carousel-control" data-slide="next" href="#multi-item-example-bestSeller" role="button"
           data-slide="next">
