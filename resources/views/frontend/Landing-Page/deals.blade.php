<div class="divider-new version-2 mt-5 mb-0">
    <h4 class="text-uppercase font-weight-bold deep-grey-text mr-3">Hot deals</h4>
</div>
    ...
    <div id="multi-item-example-deals" class="carousel slide carousel-multi-item" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
            @for($i = 0;$i < count($deals);$i++)
                <li class="{{$i == 0 ? 'active' : ''}}" data-target="#multi-item-example-deals" data-slide-to="{{$i}}"></li>
            @endfor
        </ol>
                        ...
                        @foreach($deal as $product)
                            ...
                            <div class="">
                                ...
                                <div class="pt-4">
                                    ...
                                    <del><h6 class="mb-1"><span>{{$product['price']}}$</span></h6></del>
                                    <h6 class="mb-1"><span>{{$product['price']-( ($product['price'] * ($product['discount']/100)))}}$</span></h6>
        ...
        <!-- Slides -->
        <a class="carousel-control-prev left carousel-control" data-slide="prev" href="#multi-item-example-deals" role="button"
           data-slide="prev">
            <span class="icon-prev" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>

        <a class="carousel-control-next right carousel-control" data-slide="next" href="#multi-item-example-deals" role="button"
           data-slide="next">
