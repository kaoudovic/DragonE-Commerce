            ...
            <div class="col-lg-4 mt-3 mb-4">
                ...
                <section>
                    ...
                    <div class="text-muted small text-uppercase mb-5">
                        ...
                        <p class="mb-3"><a href="{{ route('phone')}}" class="card-link-secondary">Mobile Phone</a></p>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    ...
                                    ('Pictures_Project/Cameras/11.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px" src="{{asset('Pictures_Project/Cameras/1.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px" src="{{asset('Pictures_Project/Cameras/2.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset('Pictures_Project/Cameras/3.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset('Pictures_Project/Cameras/4.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset
                                    ('Pictures_Project/Cameras/5.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100"  style="height: 250px"  src="{{asset('Pictures_Project/Cameras/6.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Cameras/7.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Cameras/8.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100"  style="height: 250px"  src="{{asset('Pictures_Project/Cameras/10.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Cameras/9.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Cameras/Canon%20EF%2070.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
