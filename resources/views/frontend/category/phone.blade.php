                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px" src="{{asset('Pictures_Project/phone/1.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px" src="{{asset('Pictures_Project/phone/2.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset('Pictures_Project/phone/3.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset('Pictures_Project/phone/4.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100"  style="height: 250px"  src="{{asset('Pictures_Project/phone/6.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/phone/7.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/phone/8.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100"  style="height: 250px"  src="{{asset('Pictures_Project/phone/10.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/phone/9.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
