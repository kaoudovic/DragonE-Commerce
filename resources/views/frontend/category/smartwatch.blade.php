            ...
            <div class="col-lg-4 mt-3 mb-4">
                ...
                <section>
                    ...
                    <div class="text-muted small text-uppercase mb-5">
                        ...
                        <p class="mb-3"><a href="{{ route('phone')}}" class="card-link-secondary">Mobilephone</a></p>
                        <p class="mb-3"><a href="{{ route('laptop')}}" class="card-link-secondary">Laptop</a></p>
                        <p class="mb-3"><a href="{{ route('tablet')}}" class="card-link-secondary">Tablet</a></p>
                        <p class="mb-3"><a href="{{ route('camera')}}" class="card-link-secondary">Camera</a></p>
                        <p class="mb-3"><a href="{{ route('game')}}"   class="card-link-secondary">Video Game</a></p>
                        <p class="mb-3"><a href="{{ route('ele')}}" class="card-link-secondary">Electronics</a></p>
                        <p class="mb-3"><a href="{{ route('headphone')}}" class="card-link-secondary">Headphone</a></p>
                        <p class="mb-3"><a href="{{ route('swatch')}}" class="card-link-secondary">Smart Watch</a></p>
                        <p class="mb-3"><a href="{{ route('tv')}}" class="card-link-secondary">TV</a></p>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    ...
                                    ('Pictures_Project/Electronics/Smartwatch/11.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                                ...
                                <div class="text-center pt-4">
                                    ...
                                    <h5>Smart Watch  </h5>
                                    <h6 class="mb-3">$ 55.00</h6>
                                    <button type="button" class="btn btn-primary btn-sm mr-1"><i class="fas fa-shopping-cart pr-2"></i>Add to cart</button>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px" src="{{asset('Pictures_Project/Electronics/Smartwatch/1.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px" src="{{asset('Pictures_Project/Electronics/Smartwatch/2.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset('Pictures_Project/Electronics/Smartwatch/3.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset('Pictures_Project/Electronics/Smartwatch/4.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset
                                    ('Pictures_Project/Electronics/Smartwatch/5.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100"  style="height: 250px"  src="{{asset('Pictures_Project/Electronics/Smartwatch/6.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Electronics/Smartwatch/7.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Electronics/Smartwatch/8.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100"  style="height: 250px"  src="{{asset('Pictures_Project/Electronics/Smartwatch/10.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Electronics/Smartwatch/9.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset
                                    ('Pictures_Project/Electronics/Smartwatch/3.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
