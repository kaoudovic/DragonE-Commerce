            ...
            <div class="col-lg-4 mt-3 mb-4">
                ...
                <section>
                    ...
                    <div class="text-muted small text-uppercase mb-5">
                        ...
                        <p class="mb-3"><a href="{{ route('tablet')}}" class="card-link-secondary">Mobile Phone</a></p>
                        ...
                        <p class="mb-3"><a href="{{ route('headphone')}}"
                                           class="card-link-secondary">HeadPhone</a></p>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    ...
                                    ('Pictures_Project/Tablets/3.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px" src="{{asset('Pictures_Project/Tablets/1.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px" src="{{asset('Pictures_Project/Tablets/2.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset
                                    ('Pictures_Project/Tablets/11.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset('Pictures_Project/Tablets/4.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"  src="{{asset
                                    ('Pictures_Project/Tablets/5.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100"  style="height: 250px"  src="{{asset('Pictures_Project/Tablets/6.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Tablets/7.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Tablets/8.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100"  style="height: 250px"  src="{{asset('Pictures_Project/Tablets/10.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height: 250px"   src="{{asset('Pictures_Project/Tablets/9.jpg')}}"
                                         alt="Sample">
                                    <a href="#!">
                                        <div class="mask"></div>
                                    </a>
